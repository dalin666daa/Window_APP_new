...
class AddTestDialog(QDialog):
    ...
    def __init__(self):
        ...
        self.model_combo.setStyleSheet("""
            QComboBox {
                color: cyan;  # Text color in the combobox
            ...
            QComboBox QAbstractItemView {
                background-color: #222;  # Dark background for the dropdown list
                color: #00FFFF;  # Light cyan text color for the dropdown items
                selection-background-color: #333;  # Darker background when an item is selected
    ...
    def add_shadow_effect(self, widget):
        ...
        shadow.setColor(QColor(0, 255, 255))  # Neon cyan shadow
    ...
    def set_futuristic_ui(self):
        ...
        app_palette.setColor(QPalette.Base, QColor(24, 24, 24))
        app_palette.setColor(QPalette.Button, QColor(28, 28, 28))
        app_palette.setColor(QPalette.WindowText, QColor(0, 255, 255))
        app_palette.setColor(QPalette.ButtonText, QColor(0, 255, 255))
        app_palette.setColor(QPalette.Highlight, QColor(0, 255, 255))
